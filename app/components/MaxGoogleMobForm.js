...
const MaxGoogleMobForm = ({ formatService, isInhouse }) => {
  ...
  return (
    <div className={`md:hidden relative max-w-sm mx-auto rounded-[20px] bg-[#FFE6F1] z-[8] mb-10 ${isInhouse ? 'mt-[20px]' : ''}`}>
      ...
      <div className="px-8">
        {/* EMI Text */}
        <div className="md:hidden text-center text-[#5E2671] text-[13px] font-bold mt-2">
        ...
        {errorMessage && (
          <div className="mt-2 flex justify-center">
            <p className="text-red-500 text-[14px] text-center font-medium">{errorMessage}</p>
          </div>
        )}
        ...
        <div className="mt-4 space-y-4 px-2">
          ...
          <div className="flex items-center border-b border-[#5E2671] pb-1 relative">
            ...
            <div className="flex-1">
              <input
                ...
                maxLength="10"
                disabled={isSubmitting}
                className="w-full bg-transparent text-[#333333] placeholder-[#333333] placeholder:text-[16px] outline-none disabled:opacity-50"
              />
            </div>
          </div>
          ...
          {isInhouse && (
            <div className="flex items-center border-b border-[#5E2671] pb-1 mt-6">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-[26px] h-[26px] mr-4 text-[#5E2671]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="flex-1">
                <select
                  ...
                  disabled={isSubmitting}
                  className={`w-full bg-transparent text-[#333333] outline-none mt-2 disabled:opacity-50 ${formData.selectedClinic ? '' : 'text-opacity-70'}`}
                >
...
export default MaxGoogleMobForm;