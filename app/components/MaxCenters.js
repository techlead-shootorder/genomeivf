    ...
    return (
        <section id='Locations' className="bg-gray-50 py-8 md:py-16 relative">
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-left mb-8 md:flex md:items-center md:gap-3">
                    <div className="text-[55px] md:text-5xl font-bold text-secondary">Our Centre Oasis Genome</div>
                    <span className="hidden md:inline-block text-[29px] font-bold text-[#2B5F8A] md:mt-2">-</span>
                    <h2 className="text-[29px] font-bold text-[#2B5F8A] md:mt-2">
                        <span className="md:hidden">- </span>The Fertility Centre
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm h-full flex flex-col justify-center">
                        <h3 className="text-2xl font-bold text-[#1E4A6E] mb-4">Oasis Genome Kolkata</h3>
